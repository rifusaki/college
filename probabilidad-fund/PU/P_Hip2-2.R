...
prueba.norm_1 = lillie.test(sinfusion);prueba.norm_1 

prueba.norm_2 = lillie.test(fusionado);prueba.norm_2

# la conclusion con la prueba lillie es que las  dos muestras
# provienen de una normal

ifelse(prueba.norm_1$p.value >0.1, "Los datosde la muestra 1 provienen de una normal", 
...
prueba.t = t.test(x = sinfusion,y = fusionado, alternative ="less",conf.level = 0.95 )
...
######### Prueba de hipo para la diferencia dde proporciones

#H0: pi-p2 = k, H1:p1-p2 <, >, dif k
